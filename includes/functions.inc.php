<?php
	...
	function FileIsCodeEditable($FileName)
	{

		$Extention = strtolower(GetExtension($FileName));

		if( ($Extention == "css") || ($Extention == "html") || ($Extention == "js") || ($Extention == "php") || ($Extention == "python") || ($Extention == "vb") || ($Extention == "xml") || ($Extention == "c") || ($Extention == "cpp") || ($Extention == "sql") || ($Extention == "basic") || ($Extention == "pas") || ($Extention == "perl") || ($Extention == "pl") || ($Extention == "htm") )
		{	
			return true;
		}
	...
	function FileIsHTMLEditable($FileName)
	{
